...
Backbone.Validation.Async = (function(_) {
    ...
    var Validation = (function() {
        ...
        var getValidators = function(model, attr) {
            ...
            return _.reduce(attrValidationSet, function(memo, attrValidation) {
                _.each(_.without(_.keys(attrValidation), 'msg', 'async'), function(validator) {
                    memo.push({
            ...
            if (!validators.length) {
                ...
                var invokeValidator = function(validator) {
                    ...
                    deferred.promise().then(
                        ...
                        function(error) {
                            masterDeferred.reject(_.result(validator, 'msg') || error);
                        }
                    );
            ...
            return {
                ...
                isValid: function(option, success, failure) {
                    ...
                    if (attrs) {
                        ...
                        var invokeValidation = function(view, attr) {
                            var value = flattened[attr];
                            var result = $.Deferred();
                            result.promise().then(
                                function() {
                                    ...
                                    var nextAttr = attrs.shift();
                                    if (nextAttr) {
                                        invokeValidation(view, nextAttr);
                                    }
                ...
                validate: function(attrs, setOptions, valid, invalid) {
                    ...
                    validateModel(model, allAttrs, picked).then(function(result) {
                        ...
                        _.defer(function() {
                            ...
                            model.trigger(
                                'validated:' + (model._isValid ? 'valid' : 'invalid'),
                                model,
                                result.invalidAttrs
                            );
                        });
    ...
    var defaultValidators = Validation.validators = (function() {
        ...
        return {
            ...
            required: function(value, attr, required, model, computed) {
                var isRequired = _.isFunction(required) ?
            ...
            pattern: function(value, attr, pattern, model) {
                if (!hasValue(value) || !value.toString().match(defaultPatterns[pattern] || pattern)) {
                    return this.format(
                        defaultMessages[pattern] || defaultMessages.inlinePattern,
                        this.formatLabel(attr, model),
                        pattern
                    );
                }
    ...
    _.each(
        defaultValidators, function(validator, key) {
            defaultValidators[key] = _.bind(
